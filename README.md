...
Summarizer Agent → Condenses analysis into clear and simple bullet points.

Business Strategy Agent → Suggests actionable strategies to improve sales and reduce costs.

Customer Support Agent → Handles user queries (e.g., “Which product had the highest revenue in June?”).
...
Groq API (LLM for reasoning & insights)

Pandas (CSV data handling)

Matplotlib / Seaborn (charts & visualizations, optional)
